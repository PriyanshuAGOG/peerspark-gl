...
export function MobileNavigation() {
  ...
  // Hide navigation when in pod detail pages
  const isInPodDetail = pathname.includes("/pods/") && pathname !== "/app/pods"
  ...
  return (
    <div
      ...
      data-mobile-nav
    >
      <div className="grid grid-cols-5 h-16" style={{ paddingBottom: "max(0px, env(safe-area-inset-bottom))" }}>
